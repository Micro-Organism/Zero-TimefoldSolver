package com.zero.timefold.solver.common.solver;
...
import com.zero.timefold.solver.common.solver.justifications.*;
...
public class TimetableConstraintProvider implements ConstraintProvider {
    ...
    Constraint roomConflict(ConstraintFactory constraintFactory) {
        ...
        return constraintFactory
                ...
                .forEachUniquePair(LessonEntity.class,
                        // ... in the same timeslot ...
                        Joiners.equal(LessonEntity::getTimeslot),
                        // ... in the same room ...
                        Joiners.equal(LessonEntity::getRoom))
    ...
    Constraint teacherConflict(ConstraintFactory constraintFactory) {
        ...
        return constraintFactory
                .forEachUniquePair(LessonEntity.class,
                        Joiners.equal(LessonEntity::getTimeslot),
                        Joiners.equal(LessonEntity::getTeacher))
                .penalize(HardSoftScore.ONE_HARD)
                .justifyWith(
    ...
    Constraint studentGroupConflict(ConstraintFactory constraintFactory) {
        ...
        return constraintFactory
                .forEachUniquePair(LessonEntity.class,
                        Joiners.equal(LessonEntity::getTimeslot),
                        Joiners.equal(LessonEntity::getStudentGroup))
                .penalize(HardSoftScore.ONE_HARD)
    ...
    Constraint teacherTimeEfficiency(ConstraintFactory constraintFactory) {
        ...
        return constraintFactory
                .forEach(LessonEntity.class)
                .join(LessonEntity.class, Joiners.equal(LessonEntity::getTeacher),
    ...
    Constraint studentGroupSubjectVariety(ConstraintFactory constraintFactory) {
        ...
        return constraintFactory
                .forEach(LessonEntity.class)
                .join(LessonEntity.class,
                        Joiners.equal(LessonEntity::getSubject),
                        Joiners.equal(LessonEntity::getStudentGroup),
                        Joiners.equal((lesson) -> lesson.getTimeslot().getDayOfWeek()))
                .filter((lesson1, lesson2) -> {
                    Duration between = Duration.between(lesson1.getTimeslot().getEndTime(),
